...
if (
    isset($_GET['selected_admin_name_activate']) &&
    isset($_GET['selected_admin_emailaddress_activate'])
) {
    $selected_admin_username = $_GET['selected_admin_name_activate'];
    $selected_admin_emailaddress = $_GET['selected_admin_emailaddress_activate'];
}
...
<body>
    <h3 class="text-success">Activate admin account</h3>
    ...
    <div class="text-center container mt-5 border p-2 shadow">
        ...
        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#activateadminaccountconfirmationModal">
    ...
    <div class="modal" id="activateadminaccountconfirmationModal">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">Activate admin account Confirmation</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>

                    <!-- Modal Body -->
                    <div class="modal-body">
                        Are you sure to activate this Admin account?.
                    </div>

                    <!-- Modal Footer -->
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                        <button type="submit" class="btn btn-success" name="activate_account_button">Confirm Activation</button>
                    </div>
        ...
        <form action="" method="POST">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <!-- Modal Header -->
                    <div class="modal-header">
                        <h4 class="modal-title">Dismiss Activate account process</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
...
if (isset($_POST['activate_account_button'])) {
    $update_admin_status_querry = "UPDATE `admin_table` SET admin_isverified='1' WHERE admin_username='$adminUsername' && admin_emailaddress='$adminEmailaddress'";
