  ...
  <tbody class="text-center">
    ...
    <?php
      ...
      if ($user_order_status == 'Online payment-complete payment') {
        ...
        echo "<td><a href='confirm_online_payment.php?order_id=$user_order_id' style='pointer-events: none; cursor: not-allowed;'>Pay online</a></td> </tr>";

      }



      echo "<script>consol.log('end of the while loop')</script>";
